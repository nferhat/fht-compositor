...
pub enum ComplexKeyAction {
    ...
    SendAndFollowToWorkspace(usize),
...
impl<'de> Deserialize<'de> for GestureAction {
        ...
        D: Deserializer<'de>,
    {
        ...
        match s.as_str() {
            ...
            "swap-window-down" => Ok(GestureAction::SwapWindowDown),
            "swap-window-up" => Ok(GestureAction::SwapWindowUp),
            "swap-window-left" => Ok(GestureAction::SwapWindowLeft),
            "swap-window-right" => Ok(GestureAction::SwapWindowRight),
            _ => Err(serde::de::Error::unknown_variant(
                &s,
                &[
